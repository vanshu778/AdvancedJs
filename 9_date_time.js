...
// console.log(currentDate);
// console.log(day);
// In JavaScript, the first day of the week (day) is Sunday.
...
//     console.log(new Date("1707091200000"));
//let updatedDate = date.setDate(date.getData()+extraDay)
...
// Question: Wr ite a function to calculate the difference in days between two given dates.
